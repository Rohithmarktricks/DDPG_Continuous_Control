...
def main():
    ...
    parser.add_argument('steps', type=int, help="Number of steps in each episode")
    ...
    # Train the agent.
    mean_scores, moving_avgs = train_twenty_agents(env, brain_name, agent, n_episodes=episodes, max_t=steps)
